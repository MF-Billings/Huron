...
// code samples: https://developers.google.com/maps/documentation/android-api/code-samples
...
//        42.9918492,-79.2544975
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        // http://blog.teamtreehouse.com/beginners-guide-location-android code
...
//        }
    ...
    public void onLocationChanged(Location location) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(latLng, DEFAULT_ZOOM));
        mMap.addMarker(new MarkerOptions().position(latLng).title(time));
